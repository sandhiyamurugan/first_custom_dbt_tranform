  ...
  create  table "my_destination_database".my_schema."table_two__dbt_tmp"
  as (
    
with __dbt__cte__table_two_ab1 as (

-- SQL model to parse JSON blob stored in a single column and extract into separated field columns as described by the JSON Schema
-- depends_on: "my_destination_database".my_schema._airbyte_raw_table_two
select
...
from "my_destination_database".my_schema._airbyte_raw_table_two as table_alias
-- table_two
where 1 = 1
...
-- table_two from "my_destination_database".my_schema._airbyte_raw_table_two
where 1 = 1
  );